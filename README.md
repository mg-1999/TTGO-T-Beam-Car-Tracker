...
6. Install [these](https://github.com/WCHSoftGroup/ch34xser_macos) drivers for MacOS 
7. Set up Arduino IDE with:
* Board: "T-Beam"
* Upload Speed: "115200"
...
12. [Log in to myDevices Cayenne](https://cayenne.mydevices.com/), on the top click on `+` and enter project name
13. Click on **Add new** -> **Device/Widget** -> **LoRa** -> **The Things Network** -> **Cayenne LPP**
14. Choose your **Name** and fill out **DevEUI** (copy **Device EUI** from [TTN Console](https://console.thethingsnetwork.org/)). Then select **Activation Mode** -> **Already Registered**, **Tracking** -> **This device moves**. Click **Add device**.
15. If your tracker already sent any data to TTN, you'll see bunch of data fields. You can drag them to your Cayenne project.
16. Install the **Cayenne** mobile app to your Android/iPhone.
